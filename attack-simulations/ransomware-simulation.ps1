...
Write-ColorOutput "   source:MAQ-1 AND message:`"encrypted`" OR message:`"ransom`"" "White"
Write-ColorOutput ""
Write-ColorOutput "2. Process creation events:" "White"
Write-ColorOutput "   source:MAQ-1 AND event_id:4688 AND message:`"ransomware`"" "White"
Write-ColorOutput ""
Write-ColorOutput "3. Registry modifications:" "White"
Write-ColorOutput "   source:MAQ-1 AND event_id:4657 AND message:`"RansomwareSim`"" "White"
Write-ColorOutput ""
Write-ColorOutput "4. Network connections:" "White"
Write-ColorOutput "   source:MAQ-1 AND message:`"192.168.1.100:4444`"" "White"
Write-ColorOutput ""
